        ...
        <el-card>
          ...
          <el-form :model="form" label-width="90px">
            ...
            <el-form-item label="训练目标">
              <el-input
                v-model="form.goal"
                placeholder="如：帮助学员科学减脂增肌"
              />
            </el-form-item>
            <el-form-item label="密码">
              <el-button size="small" @click="pwdDialog = true"
                >修改密码</el-button
              >
            </el-form-item>
          </el-form>
          ...
          <el-form :model="form" label-width="100px">
            ...
            <el-form-item label="详细介绍">
              <el-input
                ...
                type="textarea"
                :rows="5"
                placeholder="介绍你的执教理念、服务内容、成功案例等..."
                maxlength="500"
                show-word-limit
              />
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    isTagSelected(tag) {
      return (this.form.specialties || "")
        .split(",")
        .map((s) => s.trim())
        .includes(tag);
    },
    toggleTag(tag) {
      const arr = (this.form.specialties || "")
        .split(",")
        .map((s) => s.trim())
        .filter(Boolean);
